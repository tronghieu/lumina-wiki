...
export default {
  ...
  'warn.upgrade_header':                       '[警告] Lumina 已从 v{from} 升级到 v{to}。部分旧的 wiki 条目需要处理:',
  'warn.upgrade_errors':                       '       {errors} 个错误、{warnings} 个警告。',
  'warn.upgrade_fix_auto':                     '     自动修正可以自动处理的问题:',
  'warn.upgrade_fix_auto_cmd':                 '       node _lumina/scripts/lint.mjs --fix',
  'warn.upgrade_fix_manual':                   '     还有 {count} 项需要你来判断,查看具体建议:',
  'warn.upgrade_fix_manual_suggest_cmd':       '       node _lumina/scripts/lint.mjs --suggest',
  'warn.upgrade_fix_manual_cmd':               '       /lumi-migrate-legacy',
  'warn.upgrade_footer':                       '     可以放心重复运行。详情见 _lumina/CHANGELOG.md。',
