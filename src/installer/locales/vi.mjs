...
export default {
  ...
  'warn.upgrade_header':                       '[cảnh báo] Lumina đã nâng cấp v{from} -> v{to}. Một số mục wiki cũ cần được xem lại:',
  'warn.upgrade_errors':                       '       {errors} lỗi, {warnings} cảnh báo.',
  'warn.upgrade_fix_auto':                     '     Sửa những gì có thể tự động sửa:',
  'warn.upgrade_fix_auto_cmd':                 '       node _lumina/scripts/lint.mjs --fix',
  'warn.upgrade_fix_manual':                   '     Còn {count} vấn đề cần bạn quyết định. Xem gợi ý cụ thể:',
  'warn.upgrade_fix_manual_suggest_cmd':       '       node _lumina/scripts/lint.mjs --suggest',
  'warn.upgrade_fix_manual_cmd':               '       /lumi-migrate-legacy',
  'warn.upgrade_footer':                       '     An toàn khi chạy lại. Xem chi tiết tại _lumina/CHANGELOG.md.',
