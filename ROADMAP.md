...
Lumina-Wiki has reached **v1.0.0** stable.
...
- **Multilingual Installer:** Support English, Vietnamese, and Chinese during the installation process, including localized CLI prompts and documentation seeding.
...
- **CI/CD Hardening:** Expand the test matrix to include Bun and Node 22 LTS environments.
- **Stability Lock:** Finalize CLI flags and exit code contracts to ensure long-term tool compatibility.
- **Schema Parity:** Standardize cross-source ID handling across all core and research skills.
...
- **Local Cache Layer:** Implement session-level caching for fetcher responses to optimize rate limits.
