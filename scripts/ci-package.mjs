...
const requiredFiles = [
  ...
  'src/installer/registry.js',
  'src/installer/agents-manifest.js',
  'src/installer/wikis-command.js',
  'src/installer/layout.js',
  ...
  'src/skills/packs/learning/reflect/SKILL.md',
  'src/skills/agents/hub/SKILL.md',
  'src/templates/README.md',
  'src/templates/partials/librarian-preamble.md',
